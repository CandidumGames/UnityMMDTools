...
{
    /// <summary>
    /// Shared toolbar-style tab bar for the UMT scripted-importer inspectors. Draws a centered,
    /// fixed-height row of tab buttons and returns the selected index.
    /// </summary>
    internal static class UMTImporterTabBar
    {
        private const float k_Height = 24.0f;

        /// <summary>Draws the tab bar and returns the index of the selected tab.</summary>
